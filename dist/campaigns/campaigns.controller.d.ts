...
export declare class CampaignsController {
    ...
    updateNote(noteId: string, body: any): Promise<{
        id: string;
        campaignId: string;
        type: string;
        text: string;
    ...
    addRecommendation(id: string, body: any): Promise<{
        id: string;
        campaignId: string;
        sortOrder: number;
        authorityName: string;
    ...
    updateRecommendation(recId: string, body: any): Promise<{
        id: string;
        campaignId: string;
        sortOrder: number;
        authorityName: string;
    ...
    addAppendix(id: string, body: any): Promise<{
        symbol: string;
        id: string;
        campaignId: string;
        text: string;
    }>;
    updateAppendix(appId: string, body: any): Promise<{
        symbol: string;
        id: string;
        campaignId: string;
        text: string;
